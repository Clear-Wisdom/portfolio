                ...
                <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
                    ...
                    >
                        {logo ? (
                            ...
                            <div className="text-xl font-bold hover:opacity-75 transition-opacity" style={{ color: menuColor || "#000" }}>
                                {logoAlt}
                            </div>
                        )}
                    </div>
                        ...
                        >
                            ...
                            <div className="nav-card-links mt-auto flex flex-col gap-[2px]">
                                {item.links?.map((lnk, i) => (
                                    <div
                                        key={`${lnk.label}-${i}`}
                                        className="nav-card-link inline-flex items-center gap-[6px] text-[15px] md:text-[16px] pointer-events-none"
                                    >
                                        <GoArrowUpRight
